...
float somma(float n1,float n2) { return n1+n2; } 
 
float differenza(float n1,float n2) { return n1-n2; } 
 
float moltiplicazione(float n1,float n2) { return n1*n2; }
 
float divisione(float n1,float n2) { return n1/n2; }
...
void stampa(float n1,float n2,float sum,float dif,float mul,float div){
 ...
 cout << "Executing all operations:" << endl;
 cout<<"SUM: "<<sum<<endl;
